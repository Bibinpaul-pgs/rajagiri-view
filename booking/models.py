...
class Booking(models.Model):
    ...
    guest_phone_number = models.CharField(max_length=20, null=True, blank=True)
    guest_email = models.EmailField(unique=False, null=True, blank=True)
    guest_address = models.CharField(max_length=255, null=True, blank=True)
    guest_id_proof_type = models.CharField(max_length=50, null=True, blank=True)
    guest_id_proof_number = models.CharField(max_length=100, null=True, blank=True)
